...
const descripcion = 'Estudiante de Programación - UTN';
const residencia = 'San Rafael, Mendoza, Argentina';
const presentacion = 'Hola, Bienvenido a mi portafolio de proyectos. Soy un estudiante de la tecnicatura en programacion de la UTN';
const redesSociales = [
...
const telefono = '+54 9 2604-597616';
</script>
